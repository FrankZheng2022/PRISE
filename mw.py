...
def make(name, frame_stack, action_repeat, seed, train=False, cam_name='corner2', img_size=84, episode_length=200, device_id=-1):
    env = mw_gym_make(name+'-v2', cam_height=img_size, cam_width=img_size, cam_name=cam_name, train_distrib=train, seed=seed, device_id=device_id)
